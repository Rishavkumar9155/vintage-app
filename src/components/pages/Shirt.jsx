...
const Shirt = () => {
  ...
  const shirtItem = {
    name: '100% linen slim-fit suit jacket',
    price: 2395,
    img: "https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67076725_09.jpg?ts=1709541214230&imwidth=500&imdensity=2"
  };
  ...
  return (
    <div className="shirt-container  flex  h-[100%] w-[100%] items-start justify-center">
      ...
      {/* <img className="w-7" src={shirtItem.img} alt="Shirt Image" /> */}
<div className="maincontainer h-[365vh] overflow-hidden w-[65%] ">
  <div className="divxx flex justify-center items-center gap-1 pt-[10vh]">
<div className="img1  w-[50%] h-[100vh]   bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67076725_09.jpg?ts=1709541214230&imwidth=500&imdensity=2')]"></div>
<div className="img2 w-[50%] h-[100vh]  bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/outfit/S20/67076725_09-99999999_01.jpg?ts=1709541214230&imwidth=500&imdensity=2')]"></div>
</div>


<div className="divxx  flex justify-center items-center gap-1 pt-1">
<div className="img1  w-[50%] h-[100vh]   bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67076725_09_R.jpg?ts=1709541214230&imwidth=500&imdensity=2')]"></div>
<div className="img2 w-[50%] h-[100vh]  bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67076725_09_D1.jpg?ts=1709541214230&imwidth=500&imdensity=2')]"></div>
</div>



<div className="divxx  flex justify-center items-center gap-1 pt-1">
<div className="img1  w-[50%] h-[100vh]   bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67076725_09_D2.jpg?ts=1709541214230&imwidth=500&imdensity=2')]"></div>
<div className="img2 w-[50%] h-[100vh]  bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67076725_09_D5.jpg?ts=1709893033129&imwidth=500&imdensity=2')]"></div>
</div>
<div className="divxxy  flex justify-center items-center gap-1 pt-1">
<div className="imgx  w-[25%] h-[50vh]  bg-center bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67076725_09_D6.jpg?ts=1709900045822&imwidth=246&imdensity=2')]"></div>
<div className="imgx w-[25%] h-[50vh]  bg-center bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67076725_09_D7.jpg?ts=1709900045822&imwidth=246&imdensity=2')]"></div>
<div className="imgx  w-[25%] h-[50vh]  bg-center  bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67076725_09_D8.jpg?ts=1705651395045&imwidth=246&imdensity=2')]"></div>
<div className="imgx w-[25%] h-[50vh]  bg-center bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67076725_09_B.jpg?ts=1705651395045&imwidth=246&imdensity=2')]"></div>
...
<div className="box1x h-[110vh] w-[30%]  flex pt-[10vh]  items-center justify-start font-thin font-sans ml-5 flex-col overflow-hidden">
  <div className="divn h-[18vh] w-full flex flex-col  pl-2">
    <div className="text1 text-[4vh] ">100% linen slim-fit suit jacket</div>
...
<h2 className='text-[1.5vh]'>DESCRIPTION
Long sleeve. Light fabric. Slim fit. Regular neck. Standard design. Lining only. Front closure. 100% linen fabric. Notch lapels and buttonhole. Front button closure. Welt pocket on the chest. Two front flap pockets. Long sleeves with buttoned strip cuffs. <br /> Inner lining. Inner pocket. Tailoring collection. The model is 185 cm tall and is wearing a size 50.</h2>
