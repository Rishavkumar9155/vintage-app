...
const Shirt = () => {
  ...
  const shirtItem = {
    ...
    price: 4564,
    img: "https://shop.mango.com/assets/rcs/pics/static/T6/fotos/S/67020621_99.jpg?ts=1696350772511&im=SmartCrop,width=1024,height=1434&imdensity=1"
  };
...
<div className="img1  w-[50%] h-[100vh]   bg-cover  bg-[url('https://shop.mango.com/assets/rcs/pics/static/T6/fotos/S/67010623_99.jpg?imwidth=1350&imdensity=1&ts=1700148904124')]"></div>
<div className="img2 w-[50%] h-[100vh]  bg-cover  bg-[url('https://shop.mango.com/assets/rcs/pics/static/T6/fotos/outfit/S/67010623_99-99999999_01.jpg?imwidth=1350&imdensity=1&ts=1700148904124')]"></div>
</div>


<div className="divxx  flex justify-center items-center gap-1 pt-1">
<div className="img1  w-[50%] h-[100vh]   bg-cover  bg-[url('https://shop.mango.com/assets/rcs/pics/static/T6/fotos/S/67010623_99_R.jpg?imwidth=1350&imdensity=1&ts=1700148904124')]"></div>
<div className="img2 w-[50%] h-[100vh]  bg-cover  bg-[url('https://shop.mango.com/assets/rcs/pics/static/T6/fotos/S/67010623_99_D1.jpg?imwidth=1350&imdensity=1&ts=1700148904124')]"></div>
</div>
