...
const Shirt = () => {
  ...
  const shirtItem = {
    name: 'slim fit linen and cotton suit jacket',
    price: 5934,
    img: "https://shop.mango.com/assets/rcs/pics/static/T6/fotos/S/67056312_01.jpg?ts=1709726603904&imwidth=480&imdensity=2"
  };
...
<div className="img1  w-[50%] h-[100vh]   bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67056312_01.jpg?ts=1709723003904&imwidth=500&imdensity=2')]"></div>
<div className="img2 w-[50%] h-[100vh]  bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/outfit/S20/67056312_01-99999999_01.jpg?ts=1709539454767&imwidth=500&imdensity=2')]"></div>
</div>


<div className="divxx  flex justify-center items-center gap-1 pt-1">
<div className="img1  w-[50%] h-[100vh]   bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67056312_01_R.jpg?ts=1709723003904&imwidth=500&imdensity=2')]"></div>
<div className="img2 w-[50%] h-[100vh]  bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67056312_01_D1.jpg?ts=1709539454767&imwidth=500&imdensity=2')]"></div>
</div>
...
<div className="imgx  w-[33.33%] h-[50vh]  bg-center bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67056312_01_D2.jpg?ts=1709723003904&imwidth=246&imdensity=2')]"></div>
<div className="imgx w-[33.33%] h-[50vh]  bg-center bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67056312_01_D8.jpg?ts=1705651395045&imwidth=246&imdensity=2')]"></div>
<div className="imgx  w-[33.33%] h-[50vh]  bg-center  bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67056312_01_B.jpg?ts=1705651395045&imwidth=246&imdensity=2')]"></div>
...
DESCRIPTION
Slim fit. Cotton and linen mix. Peak lapel. Front button closure. Welt pocket on the chest. Two front flap pockets. Long sleeves with buttoned strip cuffs. Half inner lining. Three inside pockets. Tailoring collection. The model is 185 cm tall and is wearing a size 50.</h2>
