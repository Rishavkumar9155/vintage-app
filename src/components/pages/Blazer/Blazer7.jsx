...
const Shirt = () => {
  ...
  const shirtItem = {
    name: 'Slim fit tencel linen tuxedo jacket',
    price: 8754,
    img: "https://st.mngbcn.com/rcs/pics/static/T6/fotos/outfit/S20/67077693_01-99999999_01.jpg?ts=1709723003904&imwidth=500&imdensity=2"
  };
...
<div className="img1  w-[50%] h-[100vh]   bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67077693_01.jpg?ts=1709723003904&imwidth=500&imdensity=2')]"></div>
<div className="img2 w-[50%] h-[100vh]  bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/outfit/S20/67077693_01-99999999_01.jpg?ts=1709723003904&imwidth=500&imdensity=2')]"></div>
</div>


<div className="divxx  flex justify-center items-center gap-1 pt-1">
<div className="img1  w-[50%] h-[100vh]   bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67077693_01_R.jpg?ts=1709723003904&imwidth=500&imdensity=2')]"></div>
<div className="img2 w-[50%] h-[100vh]  bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67077693_01_D1.jpg?ts=1709723003904&imwidth=500&imdensity=2')]"></div>
</div>
...
<div className="imgx  w-[33.33%] h-[50vh]  bg-center bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67077693_01_D2.jpg?ts=1709723003904&imwidth=246&imdensity=2')]"></div>
<div className="imgx  w-[33.33%] h-[50vh]  bg-center  bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67077693_01_D0.jpg?ts=1707393832171&imwidth=246&imdensity=2')]"></div>
<div className="imgx w-[33.33%] h-[50vh]  bg-center bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67077693_01_B.jpg?ts=1707393832171&imwidth=246&imdensity=2')]"></div>
...
DESCRIPTION
Bi-stretch fabric: its flexibility in all directions provides adaptability and comfort. Non-crease. Thermoregulating: regulates body temperature. Wool mix fabric. Slim fit. Herringbone structure. Lapel with notch. Front button closure. Long buttoned sleeve. Welt pocket on the chest. Two pockets with flaps on the front. Double back slit. Two inner pockets. Inner lining. The model is 187 cm tall and is wearing a size 50. Tailoring collection..</h2>
