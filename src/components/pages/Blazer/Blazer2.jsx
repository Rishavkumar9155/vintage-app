...
const Shirt = () => {
  ...
  const shirtItem = {
    ...
    price: 6925,
    img: "https://shop.mango.com/assets/rcs/pics/static/T6/fotos/S/67064444_56.jpg?ts=1707123804749&imwidth=480&imdensity=2"
  };
...
<div className="img1  w-[50%] h-[100vh]   bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67064444_56.jpg?ts=1707120204749&imwidth=500&imdensity=2')]"></div>
<div className="img2 w-[50%] h-[100vh]  bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/outfit/S20/67064444_56-99999999_01.jpg?ts=1707120204749&imwidth=500&imdensity=2')]"></div>
</div>


<div className="divxx  flex justify-center items-center gap-1 pt-1">
<div className="img1  w-[50%] h-[100vh]   bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67064444_56_R.jpg?ts=1707120204749&imwidth=500&imdensity=2')]"></div>
<div className="img2 w-[50%] h-[100vh]  bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67064444_56_D1.jpg?ts=1707120204749&imwidth=500&imdensity=2')]"></div>
</div>
...
<div className="imgx  w-[33.33%] h-[50vh]  bg-center bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67064444_56_D2.jpg?ts=1707123811159&imwidth=331&imdensity=2')]"></div>
<div className="imgx w-[33.33%] h-[50vh]  bg-center bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67064444_56_D8.jpg?ts=1704873844647&imwidth=331&imdensity=2')]"></div>
<div className="imgx  w-[33.33%] h-[50vh]  bg-center  bg-cover  bg-[url('https://st.mngbcn.com/rcs/pics/static/T6/fotos/S20/67064444_56_B.jpg?ts=1704873844647&imwidth=331&imdensity=2')]"></div>
...
Regular neck. Performance Collection. Quick Dry. Four way stretch: elasticity in all directions. Plus comfort in your daily life thanks to its flexibility. Lining only. Machine washable. Front closure. Slim fit. Standard design. Long sleeve. Notch lapels and buttonhole. Front button closure. Long sleeve with buttoned cuffs. Two front flap pockets. Inner lining. Light fabric. Inner pocket. The model is 185 cm tall and is wearing a size 50.</h2>
