...
const Shirt = () => {
  ...
  const shirtItem = {
    name: 'Cotton-knit polo shirt with zip ',
    price: 2790,
    img: "https://shop.mango.com/assets/rcs/pics/static/T6/fotos/S/67087695_05.jpg?ts=1710350042739&im=SmartCrop,width=640,height=896&imdensity=1"
  };
...
<div className="img1  w-[50%] h-[100vh]   bg-cover  bg-[url('https://shop.mango.com/assets/rcs/pics/static/T6/fotos/S/67087695_05.jpg?imwidth=640&imdensity=1&ts=1710350042739')]"></div>
<div className="img2 w-[50%] h-[100vh]  bg-cover  bg-[url('https://shop.mango.com/assets/rcs/pics/static/T6/fotos/outfit/S/67087695_05-99999999_01.jpg?imwidth=640&imdensity=1&ts=1710350042739')]"></div>
</div>


<div className="divxx  flex justify-center items-center gap-1 pt-1">
<div className="img1  w-[50%] h-[100vh]   bg-cover  bg-[url('https://shop.mango.com/assets/rcs/pics/static/T6/fotos/S/67087695_05_R.jpg?imwidth=640&imdensity=1&ts=1710350042739')]"></div>
<div className="img2 w-[50%] h-[100vh]  bg-cover  bg-[url('https://shop.mango.com/assets/rcs/pics/static/T6/fotos/S/67087695_05_D1.jpg?imwidth=640&imdensity=1&ts=1710350042739')]"></div>
</div>
...
<div className="imgx  w-[33.33%] h-[50vh]  bg-top bg-cover  bg-[url('https://shop.mango.com/assets/rcs/pics/static/T6/fotos/S/67087695_05_D2.jpg?imwidth=480&imdensity=1&ts=1710350042739')]"></div>
<div className="imgx w-[33.33%] h-[50vh]  bg-center bg-cover  bg-[url('https://shop.mango.com/assets/rcs/pics/static/T6/fotos/S/67087695_05_D8.jpg?imwidth=480&imdensity=1&ts=1710430598989')]"></div>
<div className="imgx  w-[33.33%] h-[50vh]  bg-center  bg-cover  bg-[url('https://shop.mango.com/assets/rcs/pics/static/T6/fotos/S/67087695_05_B.jpg?imwidth=480&imdensity=1&ts=1710430598989')]"></div>
