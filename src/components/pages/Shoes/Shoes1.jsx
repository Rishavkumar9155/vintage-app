...
const Shirt = () => {
  ...
  const shirtItem = {
    name: 'Stitched sneakers',
    price: 8564,
    img: "https://shop.mango.com/assets/rcs/pics/static/T6/fotos/S/67094437_01_B.jpg?imwidth=721&imdensity=1&ts=1700492583220"
  };
...
<div className="img1  w-[50%] h-[100vh]   bg-cover  bg-[url('https://shop.mango.com/assets/rcs/pics/static/T6/fotos/S/67094437_01_B.jpg?ts=1700492583220&im=SmartCrop,width=1024,height=1434&imdensity=1')]"></div>
<div className="img2 w-[50%] h-[100vh]  bg-cover  bg-[url('https://shop.mango.com/assets/rcs/pics/static/T6/fotos/S/67094437_01.jpg?imwidth=721&imdensity=1&ts=1700492583220')]"></div>
</div>


<div className="divxx  flex justify-center items-center gap-1 pt-1">
<div className="img1  w-[50%] h-[100vh]   bg-cover  bg-[url('https://shop.mango.com/assets/rcs/pics/static/T6/fotos/S/67094437_01_D1.jpg?imwidth=480&imdensity=1&ts=1700492583220')]"></div>
<div className="img2 w-[50%] h-[100vh]  bg-cover  bg-[url('https://shop.mango.com/assets/rcs/pics/static/T6/fotos/S/67094437_01_D2.jpg?imwidth=480&imdensity=1&ts=1700492583220')]"></div>
</div>
...
ESSENTIALS: Made to last. Running style. Rounded toe. Contrast rubber volume sole. Backstitched details.

ESSENTIALS: Made to last. We have strengthened our quality requirements by adding new resistance tests to our garments. Designed paying careful attention to their manufacture, they are now even more durable, versatile and timeless..</h2>
...
<div className="select  font-sans  flex items-center justify-center flex-col">
  ...
  <option value="S " className=''>38</option>
<option value="M " className=''>40</option>
<option value="L">42</option>
<option value="XL">44</option>
<option value="XXL">48</option>
</select>
